/**
 * flox_player_login_email_password(
 *                      String email, String password, Boolean loginOnly,
 *                      Script(Player currentPlayer) onComplete,
 *                      Script(String error, Real httpStatus, Boolean confrimationSent) onError)
